...
| `DESPLIEGUE - R2.12 enlace de acceso.md` | Despliegue de un requerimiento suelto: el enlace de acceso de un usuario se puede volver a generar. Los manuales por **fase** cubren una entrega entera; los que llevan **número de requerimiento** cubren un cambio que salió por su cuenta. | `docs/` |
