...
El día que exista la cuenta de servicio se hacen los §3.0 a §3.3 de
`DESPLIEGUE - COLOQUIO Fase 0.md` —el flag `cloudsql.iam_authentication`
incluido— y se la agrega como miembro del rol, sin volver a tocar ninguna
migración.
