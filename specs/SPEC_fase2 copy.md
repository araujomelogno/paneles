...
- **No incluye la gestión de usuarios del sistema desde la app** (solapa Configuración): se movió a Fase 3 (R3.8) para no ampliar el alcance de esta fase, ya en desarrollo. El alta sigue por `scripts/alta_usuario.js`.
